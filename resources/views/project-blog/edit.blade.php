...
<div class="container pt-5 mb-5">
	<div class="panel mx-auto w-75">
		<form method="post" action="/projects/{{ $project->code }}/blog/{{ $project_blog->id }}">
			@csrf
			@method('put')
			...
			<div class="panel__body w-75">
				<div class="form-group">
					...
					<input type="text" name="title" class="form-control" value="{{ $project_blog->title }}">
				</div>

				<div class="form-group">
					<label for="" class="fw-bold">Content</label>
					<textarea name="content" id="" cols="30" rows="10" class="form-control">{{ $project_blog->content }}</textarea>
				</div>
