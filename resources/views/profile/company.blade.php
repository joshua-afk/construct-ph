...
<section class="profile-section">
  <div class="section__head">
    <div class="d-flex">
      <h5 class="flex-grow-1"> <i class="far fa-building"></i>&ensp;Companies</h5>
      <div></div>
    </div>
    <hr class="cstm-hr">
  </div>
  <div class="section__content pt-5">
    <div class="row">
      @forelse($user->companies as $company)
      <div class="col-6">
        <div class="p-4" style="box-shadow: 0px 0px 20px 0px rgba(0, 0, 0, 0.2); border-radius: 15px;">
          ...
          <hr class="cstm-hr my-3">

          <a class="btn btn-block -lime-outline" href="/companies/{{ $company->code }}">View Company</a>
        </div> 
      </div>
      @empty
      <div class="mt-4">
